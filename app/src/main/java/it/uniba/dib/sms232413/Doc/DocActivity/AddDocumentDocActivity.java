...
public class AddDocumentDocActivity extends AppCompatActivity {
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(AddDocumentDocActivity.this, R.string.succAddDocument, Toast.LENGTH_SHORT).show();
